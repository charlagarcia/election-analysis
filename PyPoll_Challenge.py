...
largest_county_turnout_vote_percentage = 0
...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        if (county_vote_count > largest_county_turnout_votes) and (county_vote_percentage > largest_county_turnout_vote_percentage):
            largest_county_turnout_votes = county_vote_count
